...
public class DingweiActivity extends AppCompatActivity {
    ...
    private BDLocationListener mListener = new BDLocationListener() {
        ...
        public void onReceiveLocation(BDLocation location) {
            LocationResult.setText(location.getAddrStr().toString());
            Toast.makeText(getBaseContext(),location.getAddrStr().toString(),Toast.LENGTH_SHORT).show();
            ...
            if (null != location && location.getLocType() != BDLocation.TypeServerError) {
               ...
               sb.append(location.getTime());
                ...
                if (location.getLocType() == BDLocation.TypeGpsLocation) {// GPS定位结果
                    ...
                    sb.append("\ndescribe : ");
                    sb.append("网络定位成功");
                } else if (location.getLocType() == BDLocation.TypeOffLineLocation) {// 离线定位结果sb.append("\ndescribe : ");
